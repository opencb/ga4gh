...
public class GetSequenceBasesResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GetSequenceBasesResponse() {}
   ...
   * The offset position (0-based) of the returned string in the sequence. This
  value will differ for each page in a paginated request.   * @param value the value to set.
   */
  ...
  /** Creates a new GetSequenceBasesResponse RecordBuilder */
  public static org.ga4gh.methods.GetSequenceBasesResponse.Builder newBuilder() {
    return new org.ga4gh.methods.GetSequenceBasesResponse.Builder();
  }
  
  /** Creates a new GetSequenceBasesResponse RecordBuilder by copying an existing Builder */
  public static org.ga4gh.methods.GetSequenceBasesResponse.Builder newBuilder(org.ga4gh.methods.GetSequenceBasesResponse.Builder other) {
    return new org.ga4gh.methods.GetSequenceBasesResponse.Builder(other);
  }
  
  /** Creates a new GetSequenceBasesResponse RecordBuilder by copying an existing GetSequenceBasesResponse instance */
  public static org.ga4gh.methods.GetSequenceBasesResponse.Builder newBuilder(org.ga4gh.methods.GetSequenceBasesResponse other) {
    return new org.ga4gh.methods.GetSequenceBasesResponse.Builder(other);
  }
  
  /**
   * RecordBuilder for GetSequenceBasesResponse instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GetSequenceBasesResponse>
    ...
    private Builder() {
      super(org.ga4gh.methods.GetSequenceBasesResponse.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.methods.GetSequenceBasesResponse.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GetSequenceBasesResponse instance */
    private Builder(org.ga4gh.methods.GetSequenceBasesResponse other) {
            super(org.ga4gh.methods.GetSequenceBasesResponse.SCHEMA$);
      if (isValidValue(fields()[0], other.offset)) {
        this.offset = data().deepCopy(fields()[0].schema(), other.offset);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'offset' field */
    public org.ga4gh.methods.GetSequenceBasesResponse.Builder setOffset(long value) {
    ...
    public org.ga4gh.methods.GetSequenceBasesResponse.Builder clearOffset() {
    ...
    public org.ga4gh.methods.GetSequenceBasesResponse.Builder clearSequence() {
      sequence = null;
    ...
    public org.ga4gh.methods.GetSequenceBasesResponse.Builder clearNextPageToken() {
      nextPageToken = null;
    ...
    @Override
    public GetSequenceBasesResponse build() {
      try {
