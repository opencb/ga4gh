...
public class SearchCallSetsRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SearchCallSetsRequest(java.lang.String variantSetId, java.lang.String name, java.lang.Integer pageSize, java.lang.String pageToken) {
   ...
   * Only return call sets with this name (case-sensitive, exact match).   * @param value the value to set.
   */
  ...
  /** Creates a new SearchCallSetsRequest RecordBuilder */
  public static org.ga4gh.methods.SearchCallSetsRequest.Builder newBuilder() {
    return new org.ga4gh.methods.SearchCallSetsRequest.Builder();
  }
  
  /** Creates a new SearchCallSetsRequest RecordBuilder by copying an existing Builder */
  public static org.ga4gh.methods.SearchCallSetsRequest.Builder newBuilder(org.ga4gh.methods.SearchCallSetsRequest.Builder other) {
    return new org.ga4gh.methods.SearchCallSetsRequest.Builder(other);
  }
  
  /** Creates a new SearchCallSetsRequest RecordBuilder by copying an existing SearchCallSetsRequest instance */
  public static org.ga4gh.methods.SearchCallSetsRequest.Builder newBuilder(org.ga4gh.methods.SearchCallSetsRequest other) {
    return new org.ga4gh.methods.SearchCallSetsRequest.Builder(other);
  }
  
  /**
   * RecordBuilder for SearchCallSetsRequest instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SearchCallSetsRequest>
    ...
    private Builder() {
      super(org.ga4gh.methods.SearchCallSetsRequest.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.methods.SearchCallSetsRequest.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing SearchCallSetsRequest instance */
    private Builder(org.ga4gh.methods.SearchCallSetsRequest other) {
            super(org.ga4gh.methods.SearchCallSetsRequest.SCHEMA$);
      if (isValidValue(fields()[0], other.variantSetId)) {
        this.variantSetId = data().deepCopy(fields()[0].schema(), other.variantSetId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'variantSetId' field */
    public org.ga4gh.methods.SearchCallSetsRequest.Builder setVariantSetId(java.lang.String value) {
    ...
    public org.ga4gh.methods.SearchCallSetsRequest.Builder clearVariantSetId() {
      variantSetId = null;
    ...
    public org.ga4gh.methods.SearchCallSetsRequest.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'pageSize' field */
    public org.ga4gh.methods.SearchCallSetsRequest.Builder setPageSize(java.lang.Integer value) {
    ...
    public org.ga4gh.methods.SearchCallSetsRequest.Builder clearPageSize() {
      pageSize = null;
    ...
    public org.ga4gh.methods.SearchCallSetsRequest.Builder clearPageToken() {
      pageToken = null;
